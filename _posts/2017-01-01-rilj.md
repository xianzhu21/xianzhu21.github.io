...
在这里首先说明Registrant的机制，先看下Registrant类的代码。RegistrantList类中有一个ArrayList，每注册一次就创建一个Registrant对象后加入到ArrayList中，而internalNotifyRegistrants方法中遍历调用每个Registrant对象的internalNotifyRegistrant方法。
